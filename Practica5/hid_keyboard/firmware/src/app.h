...
typedef struct
{
    ...
    bool ignoreSwitchPress2;    
    bool ignoreSwitchPress3;
    ...
    bool sofEventHasOccurred2;
    bool sofEventHasOccurred3;
    ...
    unsigned int switchDebounceTimer2;
    unsigned int switchDebounceTimer3;
