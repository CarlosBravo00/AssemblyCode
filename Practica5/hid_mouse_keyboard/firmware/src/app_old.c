...
/* Check if a key was pressed */
    if(BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet(APP_USB_SWITCH_1)) || BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet(APP_USB_SWITCH_3)) || BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet(APP_USB_SWITCH_2)))
    {
        if(appData.ignoreSwitchPress)
        {
            ...
            if(appData.sofEventHasOccurred)
            {
                ...
                if(appData.switchDebounceTimer == APP_USB_SWITCH_DEBOUNCE_COUNT)
                {
                    ...
                    else if (BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet(APP_USB_SWITCH_1))){
...
void APP_EmulateKeyboard(void)
{
    ...
    else if(appData.isSwitchPressed3)
    {
         appData.isSwitchPressed3 = false;
            ...
            appData.key = USB_HID_KEYBOARD_KEYPAD_KEYBOARD_0_AND_CLOSE_PARENTHESIS;
    ...
    {
            appData.isSwitchPressed2 = false;
        appData.keyboardModifierKeys.modifierkeys = 0x01 ;
        appData.key = USB_HID_KEYBOARD_KEYPAD_KEYBOARD_C;
        appData.keyCodeArray.keyCode[0] = appData.key;
        ...
        else if(appData.isSwitchPressed3)
    {
            appData.isSwitchPressed3 = false;
        appData.keyboardModifierKeys.modifierkeys = 0x01 ;
        appData.key = USB_HID_KEYBOARD_KEYPAD_KEYBOARD_V;
        appData.keyCodeArray.keyCode[0] = appData.key;
        
        }
        else {
            appData.keyboardModifierKeys.modifierkeys = 0x00 ;
            appData.keyCodeArray.keyCode[0] =
                 USB_HID_KEYBOARD_KEYPAD_RESERVED_NO_EVENT_INDICATED;
        }
