                ...
                switch(appData.receiveDataBuffer[0])
                {
                    ...
                    case 0x81:
                        ...
                        if(appData.hidDataTransmitted)
                        {
                            ...
                            appData.transmitDataBuffer[3] = 0x01;
                    ...
                    case 0x82:
                        if (appData.hidDataTransmitted) {   //Validar que el EP_IN puede recibir informaci�n que eventualmente ser� le�da por la computadora
                            ...
                            appData.transmitDataBuffer[6]='6';
                            appData.transmitDataBuffer[7]='2';
                            appData.transmitDataBuffer[8]='7';
                            appData.transmitDataBuffer[9]='4';
                            appData.transmitDataBuffer[10]=' ';
                            appData.transmitDataBuffer[11]='&';
                            appData.transmitDataBuffer[12]=' ';
                            appData.transmitDataBuffer[13]='A';
                            appData.transmitDataBuffer[14]='0';
                            appData.transmitDataBuffer[15]='1';
                            appData.transmitDataBuffer[16]='3';
                            appData.transmitDataBuffer[17]='3';
                            appData.transmitDataBuffer[18]='8';
                            appData.transmitDataBuffer[19]='8';
                            appData.transmitDataBuffer[20]='9';
                            appData.transmitDataBuffer[21]='6';
